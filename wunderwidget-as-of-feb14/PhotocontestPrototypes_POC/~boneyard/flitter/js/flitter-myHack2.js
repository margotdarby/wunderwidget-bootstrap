...
var flitter = function flitter(key) {
    ...
    var flitterAPIkey = key || '1cf53a79f6457f45e1182a5dd78ff5f5',  // replace with your Flickr API key (fallback)
    ...
    if (supports_local_storage()) {
        ...
        localStorage = new Store('flitterImages');
    } else {
        localStorage = null;
    }
...
// strope on sight! Just on include.
