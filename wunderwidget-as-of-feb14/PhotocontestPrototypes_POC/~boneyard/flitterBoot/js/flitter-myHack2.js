/*
* margot flickerHack with API key
...
//Try replacing this 'keyed' flickr call with one to a public search, no key. Either getJSON or full-ajax code. Leave the 'self.add(response.photos.photo);' the same for the data return.
        ...
        FlickrImageView = Backbone.View.extend({
            tagName: 'a',
            template: _.template("<img src='<%= thumb_url() %>' /><p><strong>No title for you today!</strong><br/>(No ID here either)</p><div class='picpod-buttons'> <img src='images/flag-thumbsdown.gif' /> <img src='images/editorspick-thumbsup.gif' /> <img src='images/keepfornextround.gif' /> </div>"),
            className: 'photo',
        ...
        ImageView = Backbone.View.extend({
            ...
            lock: false,
            template: _.template('<div id="<%= id %>" class="flitterWrapper"><img class="flitter" src="" /><a href="#" title="Setup" class="setupIcon"></a></div><div class="flitterFlyout"><div class="flitterContent"><a href="#" title="Previous Page" class="prev">&#9664;</a><a href="#" title="Next Page" class="next">&#9654;</a></div></div>'),
            ...
            events: {
                ...
                'click .flitterFlyout a.next'    : 'nextFlickrPhotos',
                'click .flitterFlyout a.prev'    : 'prevFlickrPhotos'
            },
            ...
            render: function() {
                ...
                if (!this.ratio) {
                    ...
                    this.$('.flitterWrapper').append('<img style="width: 100%;" class="placeholder" src="http://placehold.it/' + this.ratio + '" />');
                }
                return this;
            },
            ...
            addImage: function (image) {
                ...
                this.$('.flitterFlyout').append(this.flickrImageView.render().el);
            },
            ...
            nextFlickrPhotos: function (event) {
                ...
                if(!this.lock) {
                    this.lock = true;
                    this.$('.flitterFlyout').find('a.photo').remove();
